...
interface Props {
  onClick?: () => void;
  size: number; // Tamaño opcional, por defecto es 36
  color?: string; // Color opcional, por defecto es blanco
}

const IconResult: React.FC<Props> = (Props: Props) => {
  return (
    <svg
      onClick={Props.onClick}
      width={Props.size}
      height={Props.size * (32 / 36)} // Mantiene la proporción original del SVG
      viewBox="0 0 36 32"
      fill="none"
